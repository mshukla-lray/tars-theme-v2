...
if (blindmode == 'on') {
	...
	"/wps/contenthandler/dav/fs-type1/themes/RTA.Responsive.Theme/rta-assets/css/blind_ar.css'>");
	$("head").append(cssLink); 
}
...
$(document).ready(function(e) {
	...
	$(' #main_nav_part ul.main_nav_bar>li.has_submenu').click(function(e) {
 		if (screenWidth <= 768) {
	...
	$("#readSpeakerID").attr("href", "https://app-as.readspeaker.com/cgi-bin/rsent?customerid=8316&amp;lang=ar_ar&amp;readid=readMe&amp;url="+document.location.href);
	$("#readSpeakerIDMob").attr("href", "https://app-as.readspeaker.com/cgi-bin/rsent?customerid=8316&amp;lang=ar_ar&amp;readid=readMe&amp;url="+document.location.href)
	...
	*/
	...
	$(".view").click(function(){
		if ($(this).hasClass("active")) {
			...
			'/wps/contenthandler/dav/fs-type1/themes/RTA.Responsive.Theme/rta-assets/css/blind_ar.css"]').remove();
...
$('#rtaApps').bind('slide.bs.carousel', function (e) {
  var id = $('#rtaApps .active').data('slide-number');
	  id = parseInt(id, 10);
	  id += 1;
	  //console.log(id + "/" + $('[id^=carousel-selector-]').length);
  //alert(id);
	 // if (id == $('[id^=carousel-selector-]').length) 
		// id = 0;
  $('[id^=carousel-selector-]').removeClass('selected');
...
$('a.suggestion[href*=#]').bind("click", function(e){
	...
	$('#show_login, .top-bar').click(function() {
		$me = $("#left_section");
		if ($me.css("margin-right") == "0px") 
			$me.animate({"margin-right": '-=257'});   
		else 
			$me.animate({"margin-right": '+=257'}); 
...
$(function() {
	...
	$('.companyMandatoryFields').bind('keyup blur',function(){  
		$me = $(this); 
		if (!$me.val()) 
  		 	$me.addClass("error");
		else
...
// Individual Registration : Reset
	$('#btnRIReset').click(function() { 
		...
		var sel_country_name = "الإمارات العربيّة المتّحدة";
	...
	$('#btnRCReset').click(function() { 
		...
		$("#frmRegisterCompanyWizard .company-phone-city-selector .uae-emirates").show();
		$("#frmRegisterCompanyWizard .company-phone-city-selector .other-city").hide(); 
...
function onSubmitLoginAr() {
	if ((document.getElementById('username')!=null && document.getElementById('username').value=='') || (document.getElementById('password')!=null && document.getElementById('password').value=='')) 
	{
		if(document.getElementById('userAuthenticationFailedDiv')){
			...
			document.getElementById('userAuthenticationFailedDiv').innerHTML = '&#x0627;&#x0644;&#x0631;&#x062C;&#x0627;&#x0621; &#x0625;&#x062F;&#x062E;&#x0627;&#x0644; &#x0647;&#x0648;&#x064A;&#x0629; &#x0627;&#x0644;&#x0645;&#x0633;&#x062A;&#x062E;&#x062F;&#x0645; &#x0648;&#x0643;&#x0644;&#x0645;&#x0629; &#x0645;&#x0631;&#x0648;&#x0631; &#x0635;&#x0627;&#x0644;&#x062D;&#x0629; .';
			return false;
		}
	}
...
function onSubmitMobileLoginAr(){
if ((document.getElementById('loginusername')!=null && document.getElementById('loginusername').value=='') || (document.getElementById('loginpassword')!=null && document.getElementById('loginpassword').value=='')) 
	{
		if(document.getElementById('userAuthenticationFailedDiv_Mobile')){
			...
			document.getElementById('userAuthenticationFailedDiv_Mobile').innerHTML = '&#x0627;&#x0644;&#x0631;&#x062C;&#x0627;&#x0621; &#x0625;&#x062F;&#x062E;&#x0627;&#x0644; &#x0647;&#x0648;&#x064A;&#x0629; &#x0627;&#x0644;&#x0645;&#x0633;&#x062A;&#x062E;&#x062F;&#x0645; &#x0648;&#x0643;&#x0644;&#x0645;&#x0629; &#x0645;&#x0631;&#x0648;&#x0631; &#x0635;&#x0627;&#x0644;&#x062D;&#x0629; .';
			return false;
		}
	}
...
$(document).ready(function(){
 if ( 'http:'==$(location).attr('protocol') )
	$.cookie("locale_new", "ar", { path: "/" });
 else
	$.cookie("locale_new", "ar", { path: "/", secure: true });
});
