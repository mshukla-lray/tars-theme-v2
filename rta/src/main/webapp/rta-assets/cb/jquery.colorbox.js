	...
	function appendHTML() {
		if (!$box && document.body) {
			...
			$content = $tag(div, "Content").append(
				...
				$prev = $('<button type="button"/>').attr({id:prefix+'Previous'}).html("<span class='hidepermanent'>dummytext</span>"),
				$next = $('<button type="button"/>').attr({id:prefix+'Next'}).html("<span class='hidepermanent'>dummytext</span>"),
				$slideshow = $tag('button', "Slideshow").html("<span class='hidepermanent'>dummytext</span>"),
				$loadingOverlay
			);
